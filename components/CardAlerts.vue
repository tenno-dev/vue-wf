    ...
    <v-responsive>
      ...
      <v-expansion-panel>
        <v-expansion-panel-content v-for="(alert, index) in alerts" :key="index">
          <div slot="header">
            <span>
              <span v-if="alert.MissionNightmareMode" class="red--text">Nightmare&nbsp;</span>
              {{alert.MissionType}}
            </span>vs
            <span
          ...
          <div>
            <v-list dense class="text-xs-center">
              ...
              <v-list-tile>
                ...
                <v-list-tile-action>
                  <v-list-tile-action-text>
                    ...
                    >
                      <v-avatar>
                        <v-icon dark :class="getcolourfaction(alert.MissionFaction,1)">mdi-sword</v-icon>
                      </v-avatar>
                ...
                <v-list-tile-action>
                  <v-list-tile-action-text>
                    <v-chip
                      ...
                      color="grey"
                      text-color="white"
                    >{{alert.MinEnemyLevel}} - {{alert.MaxEnemyLevel}}</v-chip>
                    <br>
                  </v-list-tile-action-text>
                </v-list-tile-action>
              </v-list-tile>
              <v-list-tile>
                ...
                <v-list-tile-action>
                  <v-list-tile-action-text>
                    <v-chip style="right: 0px;" small color="yellow  darken-2" text-color="white">
                      <v-avatar>
              ...
              <v-list-tile v-if="alert.RewardItem">
                <v-list-tile-content>
